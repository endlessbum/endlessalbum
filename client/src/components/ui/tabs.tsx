...
>(({ className, ...props }, ref) => (
  ...
  "flex flex-wrap min-h-10 items-center justify-center rounded-md border border-border-subtle bg-surface p-1 text-text-secondary gap-1",
      className
    )}
    {...props}
  />
