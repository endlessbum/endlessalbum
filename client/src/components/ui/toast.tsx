...
>(({ className, ...props }, ref) => (
  ...
  "group-[.destructive]:border-border group-[.destructive]:hover:bg-surface-hover group-[.destructive]:hover:text-primary-foreground group-[.destructive]:focus:ring-ring",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  ...
  "group-[.destructive]:text-muted-foreground group-[.destructive]:hover:text-foreground group-[.destructive]:focus:ring-ring",
      className
    )}
    toast-close=""
    {...props}
